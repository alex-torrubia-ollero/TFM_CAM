...
set lib_name PnR_simple_gates_0
...
set search_path ""
    lappend search_path /users/atorrubia/WORK/cam-stdcell-design/0_designEnvironment/1_synth+PnR_High_level/5_Results/1_Synth_results/all_gates/
}

if {$SIMPLE_GATES eq {yes}} {
set search_path ""
    lappend search_path /users/atorrubia/WORK/cam-stdcell-design/0_designEnvironment/1_synth+PnR_High_level/5_Results/1_Synth_results/simple_gates/
}
...
create_scenario -name SS_maxRC -mode func_mode -corner slow_corner
set_operating_conditions -analysis_type on_chip_variation -library { \
...
set_scenario_status SS_maxRC -active true
...
write_verilog -hierarchy all    $dir_PnR_results_all_gates/PnR_netlist.v
}
