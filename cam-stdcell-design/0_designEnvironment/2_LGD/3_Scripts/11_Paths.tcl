...
if {![file exists ../4_Output/2_PnR_reports/tool_placement]} {file mkdir ../4_Output/2_PnR_reports/tool_placement}
if {![file exists ../4_Output/2_PnR_reports/controlled_placement]} {file mkdir ../4_Output/2_PnR_reports/controlled_placement}
...
if {![file exists ../5_Results/2_PnR_results/controlled_placement]} {file mkdir ../5_Results/2_PnR_results/controlled_placement}
if {![file exists ../5_Results/2_PnR_results/tool_placement]} {file mkdir ../5_Results/2_PnR_results/tool_placement}
...
# PnR folder vars
set dir_PnR_reports_controlled_placement    ${dir_output}/2_PnR_reports/controlled_placement
set dir_PnR_reports_tool_placement          ${dir_output}/2_PnR_reports/tool_placement
set dir_PnR_results_controlled_placement    ${dir_results}/2_PnR_results/controlled_placement
set dir_PnR_results_tool_placement          ${dir_results}/2_PnR_results/tool_placement
