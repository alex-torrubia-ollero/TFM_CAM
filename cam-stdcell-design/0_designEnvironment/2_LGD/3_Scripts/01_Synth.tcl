...
puts "========================="
  ...
  read_file -format sverilog -define GATES { vlsu_cam_top.sv \
...
puts "========================="
 ...
 analyze -format sverilog -define GATES { vlsu_cam_top.sv \
       vlsu_cam_gate_level.sv
       }
...
set clkgt [get_cells -hierarchical * -filter "@ref_name==HDBSLT20_CKGTPLT_V8_1"]
set_dont_touch $clkgt

set enable_buf [get_cells *.*.read_enable_buffer]
set_dont_touch $enable_buf 
set_dont_touch [get_cells "asic_model_gen.memory_core"]
