...
# setting variables
set FPL [expr 570*0.116]
set FPH [expr 120*0.72]

set mem_core_x_offset [expr 0.116*41]
...
set lib_name PnR_uncontrolled_4
...
puts ""
puts "===="
puts "6 - PLACE BOUNDARY AND WELLTAP CELLS"
puts "===="
puts ""
...
report_qor -summary
# save_block -as design_lib:scm_post_place_opt.design
...
puts ""
puts "===="
puts "REPORTING AND SAVING"
puts "===="
puts ""

report_qor -summary                                             > $dir_PnR_reports_tool_placement/qor_summary.txt
report_design -all                                              > $dir_PnR_reports_tool_placement/design.txt
report_constraints -all_violators                               > $dir_PnR_reports_tool_placement/constraints.txt
report_utilization                                              > $dir_PnR_reports_tool_placement/utilization.txt
report_placement                                                > $dir_PnR_reports_tool_placement/placement.txt
report_ports                                                    > $dir_PnR_reports_tool_placement/ports.txt  
report_path_groups                                              > $dir_PnR_reports_tool_placement/path_groups.txt
report_timing -max_paths 50                                     > $dir_PnR_reports_tool_placement/timing.txt
report_timing -max_paths 50 -report_by scenario                 > $dir_PnR_reports_tool_placement/timing_2.txt
report_timing -delay_type min -max_paths 50 -report_by scenario > $dir_PnR_reports_tool_placement/timing_hold.txt
report_clock_qor                                                > $dir_PnR_reports_tool_placement/clock_qor.txt
report_power                                                    > $dir_PnR_reports_tool_placement/power.txt
report_power -scenario typ                                      > $dir_PnR_reports_tool_placement/power_typ.txt
report_congestion                                               > $dir_PnR_reports_tool_placement/congestion.txt
check_routes                                                      
optimize_routability -check_drc_rules                           > $dir_PnR_reports_tool_placement/drc.txt
check_empty_space; #REVISA SI FALTAN FILLERS                      
report_net_fanout                             > $dir_PnR_reports_tool_placement/fanout.txt
puts "====saving===="
print_message_info -ids * -summary

save_block -as $lib_name:cam_post_filler.design

write_sdf $dir_PnR_results_tool_placement/PnR_delays.sdf
write_verilog -hierarchy all $dir_PnR_results_tool_placement/PnR_netlist.v -split_bus
